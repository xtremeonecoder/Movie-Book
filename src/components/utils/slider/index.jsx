/**
 * Movie Book - Application - slider Component
 *
...
const Slider = ({ posters, backdrops }) => {
  ...
  return (
    <React.Fragment>
      {backdrops.length > 0 && (
        <div className="row">
          <div className="col-md-12">
            <div data-test="movieSlider" className="slider">
      ...
      {posters.length > 0 && (
        <React.Fragment>
          <h2 data-test="moviePoster" class="section-title section-title2">
            Movie Poster Images
          </h2>
          <div data-test="moviePoster" className="row">
            {posters.map((poster) => {
              imageCounter2++;
